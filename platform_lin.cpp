...
bool ensureElevated()
{
    // Rosa Image Writer needs root privileges because it writes
    // directly to the selected block device.
    ...
    QMessageBox::critical(
        ...
        ApplicationTitle,
        "<font color=\"red\">" +
        QObject::tr("Administrator privileges are required!") +
        "</font><br><br>" +
        QObject::tr("Please close this program and restart it using sudo.") +
        "<br><br>" +
        "<tt>sudo RosaImageWriter</tt>",
        QMessageBox::Ok
    );
